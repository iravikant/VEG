...
public class VajitableAdapter extends RecyclerView.Adapter<VajitableAdapter.FAQViewHolder> {

    private final String TAG = VajitableAdapter.class.getSimpleName();
    ...
    public VajitableAdapter(Context context, ProductDetailsActivity homeFragment) {
        mContext = context;
    }
