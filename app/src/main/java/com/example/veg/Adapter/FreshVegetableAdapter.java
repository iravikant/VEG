...
public class FreshVegetableAdapter extends RecyclerView.Adapter<FreshVegetableAdapter.MyViewHolder> {
    public List<HomeModel.ProductDetails> faqList;
    public Context context;

    public FreshVegetableAdapter(List<HomeModel.ProductDetails> list, Context context) {
        this.faqList = list;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.price.setText(String.valueOf("Rs."+ faqList.get(position).selling_price +" /"+faqList.get(position).product_unit));
