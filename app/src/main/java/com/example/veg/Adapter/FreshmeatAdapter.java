...
public class FreshmeatAdapter extends RecyclerView.Adapter<FreshmeatAdapter.MyViewHolder> {
    public List<HomeModel.ProductDetails> faqList;
    public Context context;

    public FreshmeatAdapter(List<HomeModel.ProductDetails> list, Context context) {
        this.faqList = list;
